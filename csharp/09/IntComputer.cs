...
namespace _09
{
    public sealed class IntComputer
    {
        ...
        public void ExecuteProgram(long[] program)
        {
            var pointer = 0L;
        ...
        private void Write(long[] program, ref long pointer, long instruction, InputOutput io)
        {
        ...
        private void Read(long[] program, ref long pointer, InputOutput io)
        {
